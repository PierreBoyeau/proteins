...
def create_kidera_mat():
    """
    Kidera, Akinori, et al. "Statistical analysis of the physical properties of the 20 naturally
...
def get_amino_acids_chemical_properties():
    ...
    properties_df = pd.read_csv(path_to_csv, sep='\t').drop(labels="amino acid", axis=1)\
        .set_index(keys='character')
